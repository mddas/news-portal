        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9 col-sm-8">
                    ...
                    <!-------------------------------------- new  Section of news-------------------------------->
                    <div class="category-style-two">
                        <div class="cat-title">
                            <div class="main-title">समाज</div>
                            <div class="sub-title"><a href="#">सबै
                                    <i class="fas fa-list"></i></a>
                            </div>
                        </div>
                                    ...
                                    <div class="main-news-list">
                                        <a href="page.html">
                                            ...
                                            <div class="abs-title">
                                                <h3 class="title">पर्सा र बारामा थप ३५ जनामा कोरोना संक्रमण पुष्टि</h3>
                                                <p>त्रिशूली, २३ साउन ।
                                                    नुवाकोटका सबै स्थानीय तहमा कोरोना सङ्क्रमणको जोखिम देखिएसँगै
                                                    ‘लकडाउन’
                                                    सरहको
                                                    आवागमनमा रोक र सार्वजनिक सेवा
                                                    प्रवाहमा कटौती गरिएको छ । नुवाकोटका सबै स्थानीय तहमा कोरोना
                                                    सङ्क्रमणको
                                                    जोखिम देखिएसँगै ‘लकडाउन’ सरहको
                                                    आवागमनमा रोक र सार्वजनिक सेवा
                                                    प्रवाहमा कटौती गरिएको छ ।</p>
                                            </div>
                    ...
                    <div class="category-style-three">
                        <div class="cat-title">
                            <div class="main-title"> राजनीति</div>
                            <div class="sub-title"><a href="#">सबै
                                    <i class="fas fa-list"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="category-style-two">
                        <div class="cat-title">
                            <div class="main-title"> विचार</div>
                            <div class="sub-title"><a href="#">सबै
                                    <i class="fas fa-list"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="category-style-three">
                        <div class="cat-title">
                            <div class="main-title"> खेलकुद</div>
                            <div class="sub-title"><a href="#">सबै
                                    <i class="fas fa-list"></i></a>
                            </div>
                        </div>
